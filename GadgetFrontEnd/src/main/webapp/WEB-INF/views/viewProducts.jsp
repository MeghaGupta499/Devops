...
<script src="<c:url value="/resources/js/mag.js" />"></script>
</head>
<body>
  <!-- 1st strts from here --><div class="row">
  <div class="col-lg-4 col-md-4 col-sm-6">
  <a data-toggle="modal" href="modelimage" data-target="#betaModal" class="img-thumbnail">
